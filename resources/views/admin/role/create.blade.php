...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <div class="btn-container">
    <a class="new-btn theme-secondary-btn" href="{{ route('admin.role.index') }}">
      All Roles
    </a>
  </div>
  ...
  <form action="{{ route('admin.role.store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="mb-3 col-6">
        ...
        <input name="name" old="name" type="text" class="form-control theme-input-form" id="" placeholder="Role Name" required>
      </div>
    </div>
